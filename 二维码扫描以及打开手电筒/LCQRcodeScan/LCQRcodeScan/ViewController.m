...
-(void)configView{
    ...
    UIButton *openBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, TOP+250, SCREEN_WIDTH, 100)];
    [openBtn setTintColor:[UIColor redColor]];
    [openBtn setTitle:@"打开手电筒" forState:UIControlStateNormal];
...
//二维码扫描时  改变背景颜色 使其变暗  生成蒙版  改变背景颜色
